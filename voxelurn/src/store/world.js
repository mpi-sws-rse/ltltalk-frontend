...
const initialHistory = [
  {x:-5,y:-5,z:0, color:"black", names: []},
  {x:-4,y:-5,z:0, color:"black", names: []},
  {x:-3,y:-5,z:0, color:"black", names: []},
  {x:-2,y:-5,z:0, color:"black", names: []},
  {x:-1,y:-5,z:0, color:"black", names: []},
  {x:0,y:-5,z:0, color:"black", names: []},
  {x:1,y:-5,z:0, color:"black", names: []},
  {x:2,y:-5,z:0, color:"black", names: []},
  {x:3,y:-5,z:0, color:"black", names: []},
  {x:4,y:-5,z:0, color:"black", names: []},
  {x:5,y:-5,z:0, color:"black", names: []},
  {x:5,y:-4,z:0, color:"black", names: []},
  {x:5,y:-3,z:0, color:"black", names: []},
  {x:5,y:-2,z:0, color:"black", names: []},
  {x:5,y:-1,z:0, color:"black", names: []},
  {x:5,y:0,z:0, color:"black", names: []},
  {x:5,y:1,z:0, color:"black", names: []},
  {x:5,y:2,z:0, color:"black", names: []},
  {x:5,y:3,z:0, color:"black", names: []},
  {x:5,y:4,z:0, color:"black", names: []},
  ...
  {x:1,y:-2,z:0, color:"blue", names: ["item"]},
  {x:1,y:-2,z:5, color:"green", names: ["item"]},
  {x:-1,y:0,z:0, color:"green", names: ["item"]},

  {x:0,y:-2,z:0, color:"fuchsia", names: ['path']},
  {x:-1,y:-2,z:0, color:"fuchsia", names: ['path']},
  {x:-1,y:-1,z:0, color:"fuchsia", names: ['destination']},
  {x:1,y:-2,z:1, color:"gray", names: ['S','robot']}
]
const initialState = {
  history: [{ text: "initial", value: initialHistory, formula: "(initial)" }],
  responses: [],
