...
class TaskList extends Component {
	...
	render() {
		if (
			this.props.isAnimationEnabled == true ||
			this.props.isKeyPressEnabled == true
		) {
			return <span />;
		}
		else {
			...
			return (
				<div
					className="task-panel-dropdown"
					style={{ background: '#4F94CD', width: '200px' }}
				>
					<div
						className="task-panel-dropdown-button"
