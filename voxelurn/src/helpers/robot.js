export function findPath(from, to, world) {
  ...
  const path1 =  [
    ...
    {x:0,y:-2,z:0, names:["pickitem"], spec: "red", completed: false},
    ...
    //{x:4,y:3,z:0, names:["dropitem"], spec: "red", completed: false},
    {x:4,y:3,z:0, names:["pickitem"], spec: "blue", completed: false},
    {x:3,y:3,z:0,color:"fuchsia",names:["path"]},
    {x:2,y:3,z:0,color:"fuchsia",names:["path"]},
  ...
  const path2 =  [
    ...
    {x:0,y:-2,z:0, names:["pickitem"], spec: "green", completed: false},
    {x:1,y:-2,z:0,names:["path"]},
    {x:2,y:-2,z:0,names:["path"]},
    {x:3,y:-2,z:0,names:["path"]},
    ...
    {x:4,y:-4,z:0, names:["dropitem"], spec: "green", completed: false},
